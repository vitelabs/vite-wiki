...
**Vite URI** is the data format used for exchanging information between dApp and Vite wallet. For more details, please refer to [Vite URI Format](../../vep/vep-6.html).

A piece of sample code shows how to call contract:
```
TODO call HelloWorld contract in Vite URI
```
