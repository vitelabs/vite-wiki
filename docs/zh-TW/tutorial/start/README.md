...
* [超级节点奖励规则](../sbp.html#出块奖励)

::: warning 为什么超级节点奖励为0? 超级节点奖励功能已经准备就绪，但是，我们希望在测试网络中测试[奖励分配规则](../sbp.html#出块奖励)，我们并不能确定目前的[规则](../sbp.html#出块奖励)是最优的。

我们计划在测试网络初期频繁调试[奖励规则的参数](../sbp.html#出块奖励)，如果将这块功能上线，我们频繁调整参数将导致非常频繁的硬分叉，为避免这种情况，在 `0.1.x`版本里，所有超级节点奖励均为 `0`。 奖励将通过官方按照[奖励规则](../sbp.html#出块奖励)计算并发放给节点。 :::
