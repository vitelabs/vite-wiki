...
```
{
  ...
  "MintageInfo": {  // 代币信息
    "TokenInfoMap": {
      "tti_5649544520544f4b454e6e40": { // 代币id，当前为vite代币
        ...
        "Decimals": 18, // 小数位数
        "Owner": "vite_00000000000000000000000000000000000000042d7ef71894", // 代币所有者
  ...
  "AccountBalanceMap": {  // 账户余额
    ...
    "vite_00000000000000000000000000000000000000042d7ef71894":{ // 共识组内置合约的账户余额
      "tti_5649544520544f4b454e6e40": 200000000000000000000000
    },
    "vite_000000000000000000000000000000000000000309508ba646":{ // 抵押合约的账户余额
