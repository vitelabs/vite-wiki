...
VX总量29,328,797，大约分8年3个月挖矿解锁，会分两个挖矿阶段：
...
* **如何参与分红**：在交易所持有的VX数量**大于或等于10 VX**即可。（**注意**：在钱包里的VX将不参与分红，若想参与分红，2019.12.6前需将VX充值到交易所合约，2019.12.6后需要进行锁仓）
...
* **抵押时间**：抵押时长无限制，2019.12.6前用户想要取回抵押，需等待**三天**才可取回。2019.12.6后的抵押可以立即取回，不过需要等待7天到账。注意：***取回抵押之后将无法继续参与抵押挖矿，若想再次参与，需再次抵押。***
...
### 邀请挖矿
  ...
  * **计算规则**：
    ...
    被邀请人将获得自己挖矿手续费的2.5%的**额外挖矿手续费**，和邀请人一样将额外获得该挖矿手续费对应比例的VX。
