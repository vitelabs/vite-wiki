...
VX是ViteX交易所发行的新的代币，持有VX的用户会终身享受到交易所每天的交易手续费和开通交易对手续费的分红。
...
* **计算规则**：
  ...
  ::::tabs
  :::tab 简单描述
  用户挂单挖矿所得的VX数量和**挂单金额，挂单时间**成线性正比，和**挂单等级**成指数级变化。
...
### 邀请挖矿
  ...
  被邀请人将享受手续费**永久**9折优惠，邀请人可**永久**获得得被邀请人产生的交易手续费的 **5%** 的挖矿额度。
  
  * **如何参与**：
    * 联系info@vite.org，申请邀请码。
...
### 上币挖矿
  ...
  在ViteX开通交易对，只需缴纳10000 VITE，其中5000 VITE销毁，4000 VITE归入手续费分红池，1000 VITE归入分红池，
  并参与交易挖矿（即等同于：该上币用户参与交易挖矿产生了 1000 VITE 的挖矿手续费）。
