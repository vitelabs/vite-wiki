...
- **Parameters**: 
  ...
  * `Address`: 奖励提取账户地址
  * `[]byte`: 出块账户公钥
  * `[]byte`: 用出块账户私钥对（发起注册交易的账户地址+注册块高度+前一个块哈希+引用的快照块哈希）签名的结果
...
{  
   ...
   "params": [
      ...
      "vite_a5a7f08011c2f0e40ccd41b5b79afbfb818d565f566002d3c6", 
      "vite_a5a7f08011c2f0e40ccd41b5b79afbfb818d565f566002d3c6",
      "81aad5b9ff60725377b7215adf4464cfed5a1504f300e90833b518426da26541==",
      "ea89ddae81a414157adc055bd159499d104f1115b613144b9edb50533a548309b4d88acf4f4b3b1ca87cadf6f65e6b5f46364690ae545ef555bf2ea3688bab0f"
    ]
}
```
...
{  
   "jsonrpc":"2.0",
   "id":1,
   "result": ""
}
```
:::
...
{  
   "jsonrpc":"2.0",
   "id":1,
   "result": ""
}
```
:::
...
- **Parameters**: 
  ...
  * `Address`: 奖励提取账户地址
  * `[]byte`: 出块账户公钥
  * `[]byte`: 用出块账户私钥对（发起更新注册信息交易的账户地址+更新注册信息块高度+前一个块哈希+引用的快照块哈希）签名的结果
...
{  
   "jsonrpc":"2.0",
   "id":1,
   "result": ""
}
```
:::
